...
- 🕓 **Daily check-in** — at 4:00 PM Singapore time, the bot asks that day's
  one-tap question. At 6:00 PM it posts anonymous results and opens a second
  poll asking who should explain their choice. Votes can change until 10:00 PM,
  when the selected person is tagged, their original answer is revealed, and they
  are asked to send a short Telegram video note.
